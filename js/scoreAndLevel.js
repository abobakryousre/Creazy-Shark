...
let showLevelUpNotificationImage = () => {
  ...
  levelSign.style.left = window.innerWidth -  LEVEL_SIGN_WIDTH  - 150 + "px";         // window.innerWidth / 2 - (levelSign.width /2 )**** + "px";           
  levelSign.style.top = window.innerHeight / 5 - containerBoundingRect.top - (levelSign.height / 2) + 150 + "px";    // window.innerHeight / 2 - containerBoundingRect.top - (levelSign.height/2)**** + "px";
